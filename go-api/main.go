...
func initONNX() error {
	...
	ortSession, err = ort.NewDynamicAdvancedSession("financial_model.onnx", []string{"float_input"}, []string{"label"}, nil)
	if err != nil {
...
func main() {
	if err := loadPreprocessing("preprocessing.json"); err != nil {
