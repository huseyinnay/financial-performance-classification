...
train_set.to_csv("../data/processed/train_set_processed.csv", index=False)
test_set.to_csv("../data/processed/test_set_processed.csv", index=False)
...
train_set_scaled.to_csv("../data/processed/train_set_processed.csv", index=False)
test_set_scaled.to_csv("../data/processed/test_set_processed.csv", index=False)
...
joblib.dump(best_model, "../models/svm_financial_model.pkl")
